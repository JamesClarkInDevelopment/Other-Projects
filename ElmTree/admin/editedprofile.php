...
session_start();
	...
	$read = "SELECT * FROM elm_User WHERE UserID ='$userID'";
	...
	$update = "UPDATE elm_User SET UniID = '$uni',Username = '$user',Password = '$pass',Email = '$email',Mobile = '$number',Instagram = '$instagram' WHERE UserID = '$userID'";
				...
				<div class="col-8 text-center">
					...
					<?php
							...
							echo $conn->error;}
								...
								echo"<h3 class='display-4 text-center'> Profile Updated </h3> 
